   ...
   return header
    ...
    handleSave = (event) => {
        ...
        if (this.state.action === "insert") {
          url = "http://localhost:2020/siswa/save"
        } else {
          url = "http://localhost:2020/siswa/update"
        }
        let form = {
    ...
    getJurusan = () => {
      let url = "http://localhost:2020/siswa/jurusan";
      // mengakses api untuk mengambil data siswa
      axios.get(url, this.headerConfig())
      .then(response => {
        // mengisikan data dari respon API ke array siswa
    ...
    Drop = (id_siswa) => {
        let url = "http://localhost:2020/siswa/" + id_siswa;
