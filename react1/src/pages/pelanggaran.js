...
class Pelanggaran extends React.Component {
    ...
    getPelanggaran = () => {
        let url = "http://localhost:2020/pelanggaran";
    ...
    handleSave = (event) => {
        ...
        if (this.state.action === "insert") {
          url = "http://localhost:2020/pelanggaran/save"
        } else {
          url = "http://localhost:2020/pelanggaran/update"
        }
    ...
    Drop = (id_pelanggaran) => {
        let url = "http://localhost:2020/pelanggaran/" + id_pelanggaran;
